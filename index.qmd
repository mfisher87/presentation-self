...
world that is built for people who think very differently than me. I have
social anxiety, so I may come across as nervous in this presentation. Also, I
may overcommunicate when I'm excited about a topic! I've been talking some
co-workers' ears off about a new tool I'm trying, called Pixi, that I feel will
make researchers' lives easier. I'm doing it right now!

**Systems thinker** - I'm very focused on systems and incentives. TODO: More about this.

I like to repair things and modify things. I have a lot of hobbies. I like
learning new things!

I taught a cohort of researchers about psychological safety this year, and that talk is recorded on YouTube and linked on this slide.

_Read off the rest of the things from the slide._
...
gantt
  ...
  Section DFS
    ...
    Interesting problems aren't enough for me :milestone, pfx-impact, 2014-01, 1d
  ...
  Section NSIDC
    ...
    Overcompensate for tone                   :milestone, pfx-tone, 2020-03, 1d
    "Deep quality" & Diátaxis                 :milestone, pfx-diataxis, 2020-06, 1d
    Universal (inclusive) design              :milestone, pfx-inclusive, 2023-04, 1d
```
...
lessons along the way, but these ones shaped who I am today as an open source
