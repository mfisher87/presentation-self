...
_TODO: Photo collage_

:::{.notes}
<!-- alex ignore amateur -->
Here's a fun photo collage of some things that are important to me. My
partner is here, my amazing dogs are here, my garden, and some fun hobby
projects. I carved flutes out of PVC pipe, built my own microphone cables,
operate a small computing cluster in my basement, play several instruments at
an amateur level (I suppose you could say I'm in a couple of "bands", but it's
different groups of friends that jam together), and some other fun stuff. I
struggle with collecting, or maybe _hoarding_ hobbies.

Hit me up on GitHub or something if you want to do a hobby project together!
:::
...
I also realized the importance of inclusive language. I use an automated
inclusive language checker called "Alex" for lots of stuff, including this
presentation.
...
:question: Community manager & [hackathon facilitator](https://earthaccess.readthedocs.io/en/latest/contributing/our-meet-ups/)

. . .

:money: [Funding proposer](https://github.com/nsidc/earthaccess-proposal-2024-nasa-roses)
