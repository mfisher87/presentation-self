...
:::{.notes}
Recently, I've grown in to an open-source community builder. For context, I'd
like to introduce _earthaccess_.
...
[:magic_wand: Magic :magic_wand:]{style="font-size: 1.5em"}
