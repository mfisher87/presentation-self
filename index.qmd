...
data viewable online and move to a Conda Forge inspired community-driven model
...
:::{.notes}
I think it's super cool that QGreenland was on the Greenlandic news.
:::
...
general, educators, and earth science researchers.
...
To make this work, I led an effort to advance the QGIS user experience in the
cloud to make it comparable to a local desktop or laptop!
:::
...
## :brain: Main takeaways from QGreenland
...
:graduation_cap: Educator & workshop facilitator
