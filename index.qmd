...
metadata andp rovenance how difficult and valuable this work can be. With robust
...
called "rainbow". In 2017, "viridis" superseded it as Matplotlib's default
thanks to work by Berkeley faculty Stéfan van der Walt and Nathaniel Smith.

_CONTROL-CLICK the "jet" visualization_

<!-- alex ignore color -->
We can see how the top colormap is inaccessible even for folks with full color
